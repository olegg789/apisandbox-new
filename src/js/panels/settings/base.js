...
import {
    ...
    Group,
    PanelHeader,
    Avatar, Header, SimpleCell, Link, Footer
} from '@vkontakte/vkui'
import {
    Icon16LikeOutline,
    Icon20BugOutline,
        ...
        <>
            ...
            <Footer>
                <Div className="podpis">
                    От <Link href="https://vk.com/id566935204" target="_blank">@kuz_s</Link> и <Link href="https://vk.com/id510624674" target="_blank">@olejii</Link>
                </Div>
                <Div className="podpis">
