...
import { Icon16Cancel, Icon20HelpOutline } from '@vkontakte/icons'
import {infoMethod} from '../../../infoMethod';
import bridge from "@vkontakte/vk-bridge";
import renderjson from 'renderjson'
import {ChipsSelect} from "@vkontakte/vkui/unstable";

function ApiPanel({ router }) {
    ...
    async function executeMethod() {
        ...
        try {
            ...
            param.map((el, index) => {
                ...
                // eslint-disable-next-line
                if (infoMethod[section].methods[infMethod].params.length === index || el === '') return
                params1[`${infoMethod[section].methods[infMethod].params[index].name}`] = el
            })
    ...
    return (
        <>
            <PanelHeader separator={false}>VK API</PanelHeader>
            <Group>
                ...
                <>
                    ...
                    <FormItem
                        ...
                        bottom={
                            infoMethod[section].methods[infMethod].access_rights.length !== 0 ?
                                <>
                                    Нужные права для вызова метода: {infoMethod[section].methods[infMethod].access_rights}.
                                </>:
                                <>
...
export default withRouter(ApiPanel);